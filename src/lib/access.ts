...
// role sees in the sidebar. Employees get the manager's oversight screens
// plus their own data-management ones — the surveyor's own work plan isn't
// relevant to them, so it's deliberately left out of their list.
...
export const NAV_BY_ROLE: Record<RoleId, NavItem[]> = {
  ...
  employee: [...MANAGER_ROUTES, ...EMPLOYEE_ONLY_ROUTES],
}
